...
from configuration_management_chatbot.tools.custom_tool import MyCustomTool
...
class AnsibleDevopsCrew():
    ...
    @task
    def understand_user_req(self) -> Task:
        return Task(
            config=self.tasks_config['understand_user_req']   
        )
